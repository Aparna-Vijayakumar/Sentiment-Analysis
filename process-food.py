...
with open('./data/unprocessed/sorted_data/gourmet_food/all.review', 'r', encoding = 'latin-1') as infile:
    copy = False
    i = 0
    for line in infile:
...
processed_data = df_counts.to_csv (r'./data/processed/food.csv', index = None, header=True)
labels = df['rating'].to_csv(r'./data/processed/foodlabels.csv', index = None, header=True)
