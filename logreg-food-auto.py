...
X = pd.read_csv('./data/processed/food.csv')
y = pd.read_csv('./data/processed/foodlabels.csv')
...
X_test = X
y_test = y
X_test = pd.read_csv ('./data/processed/automotive.csv')
y_test = pd.read_csv('./data/processed/autolabels.csv')
